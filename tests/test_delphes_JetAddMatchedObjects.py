...
def test_event(obj, mockevent):
    mockevent.GenJet20all = [
    ...
    expected = [
        Object([('PT', 927.485), ('Eta', 0.658), ('Phi', 0.360), ('Mass', 85.231)]),
        Object([('PT', 840.864), ('Eta', 0.801), ('Phi', -2.720), ('Mass', 105.558)]),
        Object([('PT', 186.931), ('Eta', 0.725), ('Phi', 3.003), ('Mass', 19.412)]),
        Object([('PT', 78.571), ('Eta', 0.984), ('Phi', -0.174), ('Mass', 10.422)]),
        ]
